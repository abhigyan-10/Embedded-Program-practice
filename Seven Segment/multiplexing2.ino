//displaying 0000 to 9999 by multiplexing  4 seven segment display by common anode
#define A (1<<0)
#define B (1<<1)
#define C (1<<2)
#define D (1<<3)
      ...
      for(k=0; k<10; k++)
      {
        ...
        // ---- Digit 1 ----
          for(short r=0;r<200;r++) //repeat to display them after multiplexing
          {
            ...
            *outB = 0x00;
            *outA = ~(digit[k]);       // Digit 3
            *outB = 0x04;              // Enable digit 4
            for(x=0; x<300; x++);

            *outB = 0x00;
            *outA = ~(digit[l]);       // Digit 4
            *outB = 0x08;              // Enable digit 4
            for(x=0; x<300; x++);
          }
        }
    }
